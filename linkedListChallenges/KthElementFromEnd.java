...
public class KthElementFromEnd {
   ...
   //O(n)
	...
	public static void main(String[] args) throws Exception {
		...
		KthElementFromEnd ll = new KthElementFromEnd();
		   ...
		   Enter(ll,n);
       		...
       		System.out.println(ll.KthElement(k));
		
	}
	
	public  int KthElement(int k) throws Exception
	{
		if(k<=0 || k>this.size)
		{
	...
	public static void Enter(KthElementFromEnd ll,int input )
	{
		if(input==-1)
		{return;}
